...
//             CanvaShapeUpdate(sCtx, sCanvas, dCtx, dCanvas, socket, existingShapes, style, {
//                 type: "rect",
//                 startX: x,
//                 startY: y,
...
//             const a = onShape(existingShapes, clientX, clientY)
//             console.log(a)
//             if (a) {
...
//             if (x.type === "line") {
//                 selectedShape.actionType = onMarkedLine(x.startX, x.startY, x.endX, x.endY, clientX, clientY, sCanvas, style)
...
//             existingShapes.forEach(x => {
//                 drawExistingShape(existingShapes, sCtx, style)
//                 if (x === selectedShape.currentShape) {
//                     selectedShape.currentSelectedShape = x
//                 }
//             })
//             markSelectedShape(sCtx, selectedShape.currentShape, selectedShape.actionType)
//         }
//     })
